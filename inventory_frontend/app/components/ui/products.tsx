                ...
                <tbody>
                    {products_.map(product =>
                        <tr className="h-8 " key={product.id}>
                            <td className="border-collapse border border-slate-400">{product.id}</td>
                            <td className="border-collapse border border-slate-400">{product.name}</td>
                            <td className="border-collapse border border-slate-400">{product.price}</td>
                            <td className="border-collapse border border-slate-400">{product.quantity}</td>
